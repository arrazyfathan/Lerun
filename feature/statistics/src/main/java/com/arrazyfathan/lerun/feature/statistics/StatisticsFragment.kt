...
import com.arrazyfathan.lerun.feature.statistics.R
import com.arrazyfathan.lerun.feature.statistics.databinding.FragmentStatisticsBinding
                ...
                it?.let {
                    ...
                    val barDataSet =
                        BarDataSet(allAverageSpeed, "Average Speed Over Time").apply {
                            ...
                            color = ContextCompat.getColor(requireContext(), UiR.color.colorAccent)
                        }

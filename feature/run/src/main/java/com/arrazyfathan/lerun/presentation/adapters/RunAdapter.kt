package com.arrazyfathan.lerun.presentation.adapters
...
import com.arrazyfathan.lerun.feature.run.databinding.ItemRunExpandableBinding
import com.arrazyfathan.lerun.utils.TrackingUtility
import com.arrazyfathan.lerun.utils.changeBackgroundColor
import com.arrazyfathan.lerun.utils.changeTextColor
import com.arrazyfathan.lerun.utils.changeTintColor
import com.arrazyfathan.lerun.utils.collapse
import com.arrazyfathan.lerun.utils.color
import com.arrazyfathan.lerun.utils.expand
            ...
            binding.rootView.setOnClickListener {
                if (expanded) {
                    ...
                    binding.imageButton.apply {
                        ...
                        changeTintColor(
                            color(itemView.context, UiR.color.main_dark),
                            color(itemView.context, UiR.color.white),
                        )
                    }
                    ...
                    binding.tvDateExpand.changeTextColor(
                        color(itemView.context, UiR.color.main_dark),
                        color(itemView.context, UiR.color.dark_accent_text),
                    )
                    val colorExpanded = color(itemView.context, UiR.color.ijo)
                    binding.rootView.changeBackgroundColor(
                        colorExpanded,
                        color(itemView.context, UiR.color.secondary_dark),
                    )
                    expanded = false
                } else {
                    ...
                    binding.rootView.changeBackgroundColor(
                        colorCollapse,
                        color(itemView.context, UiR.color.ijo),
                    )
                    expanded = true
                }
            }

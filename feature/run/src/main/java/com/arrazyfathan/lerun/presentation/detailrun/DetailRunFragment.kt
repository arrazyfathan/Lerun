package com.arrazyfathan.lerun.presentation.detailrun
...
import com.arrazyfathan.lerun.feature.run.databinding.FragmentDetailRunBinding
...
class DetailRunFragment : Fragment(R.layout.fragment_detail_run) {
    ...
    private val run: Run by lazy {
        requireNotNull(BundleCompat.getSerializable(requireArguments(), "latestrun", Run::class.java))
    }
